    ...
    <div className="min-h-screen pt-32 pb-24">
      <div className="max-w-3xl mx-auto px-6 md:px-12">
        ...
        <div className="prose prose-invert prose-sm max-w-none text-[#4A6580] space-y-6">
          ...
          <h2 className="text-[#0F2A44] font-semibold text-lg">Use of Site</h2>
          <p>
          ...
          <h2 className="text-[#0F2A44] font-semibold text-lg">Intellectual Property</h2>
          <p>
          ...
          <h2 className="text-[#0F2A44] font-semibold text-lg">Limitation of Liability</h2>
          <p>
          ...
          <p>
            Questions? Email{" "}
            <a href="mailto:legal@pentacipher.com" className="text-[#0891B2] hover:underline">
