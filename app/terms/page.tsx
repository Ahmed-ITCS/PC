  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] pt-32 pb-24">
      <div className="max-w-3xl mx-auto px-6 md:px-12">
        <Link
          href="/"
          className="group inline-flex items-center gap-2 text-[#64748B] hover:text-[#0F172A] text-sm mb-10 transition-colors"
        >
        ...
        <p className="text-[#64748B] text-sm mb-10">Last updated: July 7, 2026</p>
        <div className="prose prose-sm max-w-none text-[#475569] space-y-6">
          ...
          <h2 className="text-[#0F172A] font-semibold text-lg">Use of Site</h2>
          <p>
          ...
          <h2 className="text-[#0F172A] font-semibold text-lg">Intellectual Property</h2>
          <p>
          ...
          <h2 className="text-[#0F172A] font-semibold text-lg">Limitation of Liability</h2>
          <p>
          ...
          <h2 className="text-[#0F172A] font-semibold text-lg">Contact</h2>
          <p>
            Questions? Email{" "}
            <a href="mailto:legal@pentacipher.com" className="text-accent hover:underline">
