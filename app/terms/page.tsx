    ...
    <div className="min-h-screen pt-32 pb-24">
      <div className="max-w-3xl mx-auto px-6 md:px-12">
        ...
        <div className="prose prose-sm max-w-none text-[#0A1B2E]/55 space-y-6">
          ...
          <h2 className="text-[#0A1B2E]/80 font-semibold text-lg">Use of Site</h2>
          <p>
          ...
          <h2 className="text-[#0A1B2E]/80 font-semibold text-lg">Intellectual Property</h2>
          <p>
          ...
          <h2 className="text-[#0A1B2E]/80 font-semibold text-lg">Limitation of Liability</h2>
          <p>
