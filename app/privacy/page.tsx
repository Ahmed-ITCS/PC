  ...
  return (
    <div className="min-h-screen pt-32 pb-24">
      <div className="max-w-3xl mx-auto px-6 md:px-12">
        <Link
          href="/"
          className="group inline-flex items-center gap-2 text-[#0A1B2E]/40 hover:text-[#0A1B2E]/70 text-sm mb-10 transition-colors"
        >
          <ArrowLeft className="w-4 h-4 group-hover:-translate-x-0.5 transition-transform" aria-hidden="true" />
          Back
        </Link>
        <h1
          className="text-4xl font-bold text-[#0A1B2E] mb-3"
          style={{ fontFamily: "var(--font-syne), Syne, sans-serif" }}
        >
          Privacy Policy
        </h1>
        <p className="text-[#0A1B2E]/35 text-sm mb-10">Last updated: July 7, 2026</p>
        <div className="prose prose-sm max-w-none text-[#0A1B2E]/55 space-y-6">
          <p>
          ...
          <h2 className="text-[#0A1B2E]/80 font-semibold text-lg">Information We Collect</h2>
          <p>
          ...
          <h2 className="text-[#0A1B2E]/80 font-semibold text-lg">How We Use It</h2>
          <p>
          ...
          <h2 className="text-[#0A1B2E]/80 font-semibold text-lg">Data Retention</h2>
          <p>
            Contact form submissions are retained for 24 months. You may request
            deletion at any time by emailing{" "}
            <a href="mailto:privacy@pentacipher.com" className="text-[#00d4ff] hover:underline">
              privacy@pentacipher.com
            </a>
            .
          </p>
          <h2 className="text-[#0A1B2E]/80 font-semibold text-lg">Contact</h2>
          <p>
