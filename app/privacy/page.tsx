    ...
    <div className="min-h-screen pt-32 pb-24">
      <div className="max-w-3xl mx-auto px-6 md:px-12">
        ...
        <div className="prose prose-invert prose-sm max-w-none text-white/55 space-y-6">
          ...
          <h2 className="text-white/80 font-semibold text-lg">Information We Collect</h2>
          <p>
          ...
          <h2 className="text-white/80 font-semibold text-lg">How We Use It</h2>
          <p>
          ...
          <h2 className="text-white/80 font-semibold text-lg">Data Retention</h2>
          <p>
