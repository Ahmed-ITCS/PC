    ...
    <div className="min-h-screen bg-[#F8FAFC] pt-32 pb-24">
      <div className="max-w-3xl mx-auto px-6 md:px-12">
        ...
        <div className="prose prose-sm max-w-none text-[#475569] space-y-6">
          ...
          <h2 className="text-[#0F172A] font-semibold text-lg">Information We Collect</h2>
          <p>
          ...
          <h2 className="text-[#0F172A] font-semibold text-lg">How We Use It</h2>
          <p>
          ...
          <h2 className="text-[#0F172A] font-semibold text-lg">Data Retention</h2>
          <p>
            Contact form submissions are retained for 24 months. You may request
            deletion at any time by emailing{" "}
            <a href="mailto:privacy@pentacipher.com" className="text-accent hover:underline">
